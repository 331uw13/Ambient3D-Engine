...
void UnloadMaterial(Material material, bool should_unload_shader)
{
    // Original:
    ...
    // Modified:
    // Made material unloading have more options and a bit safer.
    // Contact: @eeiuwie:matrix.org
    // 2025-09-18
    if(should_unload_shader) {
