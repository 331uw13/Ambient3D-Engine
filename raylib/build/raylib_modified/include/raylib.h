...
//---------------------------------------------------------------------------------
// Added function options (@eeiuwie:matrix.org) 2025-09-18
//---------------------------------------------------------------------------------

// for 'UnloadMaterial' "should_unload_shader" 
#define RL_UNLOAD_MAT_SHADER true
#define RL_DONT_UNLOAD_MAT_SHADER false
...
RLAPI void UnloadMaterial(Material material, bool should_unload_shader);                    // Unload material from GPU memory (VRAM)
