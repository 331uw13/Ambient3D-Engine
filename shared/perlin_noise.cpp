...
160, 137, 91, 90, 15, 131, 13, 201, 95, 96, 53, 194, 233, 7, 225, 140, 
36, 103, 30, 69, 142, 8, 99, 37, 240, 21, 10, 23, 190, 6, 148, 247, 
120, 234, 75, 0, 26, 197, 62, 94, 252, 219, 203, 117, 35, 11, 32, 57, 
177, 33, 88, 237, 149, 56, 87, 174, 20, 125, 136, 171, 168, 68, 175, 74, 
165, 71, 134, 139, 48, 27, 166, 77, 146, 158, 231, 83, 111, 229, 122, 60, 
...
static float lerp_(float t, float min, float max) {
...
float perlin_noise_2D(float x, float y) {
    ...
    return lerp_(v, lerp_(u, grad2d(p[A], x, y), grad2d(p[B], x-1, y)),
                    lerp_(u, grad2d(p[A+1], x, y-1), grad2d(p[B+1], x-1, y-1)));
}
